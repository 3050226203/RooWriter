		...
		const generatedPackageJson = generatePackageJson({
			packageJson: {
				...
				contributes: {
					...
					views: {
						"roo-writer-ActivityBar": [
							{
								type: "webview",
								id: "roo-writer.SidebarProvider",
								name: "",
							},
						],
					},
					commands: [
						{
							command: "roo-writer.plusButtonClicked",
							title: "%command.newTask.title%",
							icon: "$(edit)",
						},
						{
							command: "roo-writer.openInNewTab",
					...
					menus: {
						"editor/context": [
							{
								submenu: "roo-writer.contextMenu",
								group: "navigation",
							},
						],
						"roo-writer.contextMenu": [
							{
								command: "roo-writer.addToContext",
								group: "1_actions@1",
							},
						],
						"editor/title": [
							{
								command: "roo-writer.plusButtonClicked",
								group: "navigation@1",
								when: "activeWebviewPanelId == roo-writer.TabPanelProvider",
							},
							{
								command: "roo-writer.settingsButtonClicked",
								group: "navigation@6",
								when: "activeWebviewPanelId == roo-writer.TabPanelProvider",
							},
							{
								command: "roo-writer.accountButtonClicked",
								group: "navigation@6",
								when: "activeWebviewPanelId == roo-writer.TabPanelProvider",
							},
						],
					...
					submenus: [
						{
							id: "roo-writer.contextMenu",
							label: "%views.contextMenu.label%",
						},
						{
							id: "roo-writer.terminalMenu",
			...
			overrideJson: {
				...
				displayName: "RooWriter Nightly",
				publisher: "RooVeterinaryInc",
				version: "0.0.1",
				icon: "assets/icons/icon-nightly.png",
				scripts: {},
			},
			substitution: ["roo-writer", "roo-code-nightly"],
		})
