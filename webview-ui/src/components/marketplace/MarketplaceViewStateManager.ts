 ...
 *
 * This class manages the state for the marketplace view in the RooWriter extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the RooWriter extensions interface
